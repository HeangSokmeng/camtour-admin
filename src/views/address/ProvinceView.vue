                    ...
                    <tbody>
                        ...
                        <tr v-else v-for="(province, index) in filteredProvinces" :key="province.id">
                            ...
                            <td class="align-middle text-end">
                                <button class="btn btn-sm btn-primary me-2" @click="editProvince(province.id)">
        ...
        <div class="modal-content">
            ...
            <form class="row g-3 needs-validation" novalidate @submit.prevent="handleSubmit">
                <div class="col-md-12">
                    ...
                    <input v-model="newProvince.name" class="form-control" id="provinceName" type="text" required />
                ...
                <div class="col-md-12">
                    ...
                    <input v-model="newProvince.local_name" class="form-control" id="provinceLocalName" type="text"
                        required />
