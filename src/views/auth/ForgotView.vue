    ...
    <div class="col mx-auto">
        <div class="auth-form-box">
            <div class="text-center">
                ...
                <p class="text-body-tertiary mb-5">Enter your email below and we will
                    <br class="d-md-none"/>send you <br class="d-none d-xxl-block"/>OTP code</p>
                <form class="mb-5"
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <button class="btn btn-primary ms-2"
                            :disabled="state.ldi_send"
                            type="submit">
                            {{ state.ldi_send ? 'Sending...' : 'Send' }}<span class="fas fa-chevron-right ms-2"></span>
                        </button>
                    </div>
                    <div v-if="vv.email.$error"
                        class="small text-danger text-start mt-1">
