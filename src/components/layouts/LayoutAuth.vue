    ...
    <main class="main"
        ...
        <div class="container-fluid bg-body-tertiary dark__bg-gray-1200">
            <div class="bg-holder bg-auth-card-overlay"
                style="background-image:url('/cr_assets/png/login_bg.png');"></div>
                        ...
                        <div class="card-body pe-md-0">
                            <div class="row align-items-center gx-0 gy-7">
                                <div class="col-auto bg-body-highlight dark__bg-gray-1100 rounded-3 position-relative overflow-hidden auth-title-box">
                                    <div class="bg-holder"
                                        style="background-image:url('/cr_assets/png/login_corner.png');"></div>
                                    <div class="position-relative px-4 px-lg-7 pt-7 pb-7 pb-sm-5 text-center text-md-start pb-lg-7 pb-md-7">
                                        <h3 class="mb-3 text-body-emphasis">ADV Dashboard</h3>
                                        <p class="text-body-tertiary">Outdoor adventure help to promote tourism in
                                            Cambodia. We’re promoting very attractive tourist place by providing the
                                            detail information such as shop, store and suggestion the best travel
                                            materials, equipment for specific area.</p>
                                        <ul class="list-unstyled mb-0 w-max-content w-md-auto">
                                            ...
                                            <li class="d-flex align-items-center">
                                                <span class="uil uil-check-circle text-success me-2"></span>
                                                <span class="text-body-tertiary fw-semibold">Admin dashboard</span>
                                            </li>
                                            <li class="d-flex align-items-center">
                                                <span class="uil uil-check-circle text-success me-2"></span>
