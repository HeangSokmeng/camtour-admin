        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                <div class="modal-header justify-content-center border-0 pt-4">
                    <div>
                        <div class="d-flex justify-content-center">
                            <img src="@/assets/img/png/question.png"
                                alt="question.png"
                                style="height: 80px;">
                        </div>
                ...
                <div class="modal-body">
                    <p class="text-body-tertiary text-center mb-0 px-7">After sign out, you need to re-enter your
                        account. Are you sure to sign out?</p>
                </div>
                <div class="modal-footer justify-content-center border-0 gap-2 pb-4">
                    <button class="btn btn-outline-primary"
                        data-bs-dismiss="modal"
                        :disabled="state.ldi_logout"
                        type="button">No, Cancel
                    </button>
...
onMounted(() => {
    globalStore.mdl_logout = Modal.getOrCreateInstance(document.getElementById('mdl-logout'))
})
