           ...
           aria-expanded="false">
            <div class="avatar avatar-l">
                <img class="rounded-circle"
                     :src="globalStore.profile ? globalStore.profile.image : '/cr_assets/png/user_default.png'"
                     alt="avatar">
            </div>
        </a>
            ...
            <div class="card position-relative border-0">
                <div class="card-body p-0">
                    <div class="text-center pt-4 pb-2">
                        ...
                        <h6 class="mt-2 text-body-emphasis">{{
                                globalStore.profile ? globalStore.profile.first_name + ' ' + globalStore.profile.last_name : ''
                            }}</h6>
                    </div>
                </div>
                <div class="overflow-auto scrollbar">
                    ...
                    <ul class="nav d-flex flex-column mb-0 pb-1">
                        <li class="nav-item">
                            <RouterLink to="/profile/edit-profile"
                        ...
                        <li class="nav-item">
                            <RouterLink to="/profile/devices"
                                        class="nav-link px-3 d-block">
                                             <span class="me-2 text-body align-bottom"
                                                   data-feather="tablet"></span>
                                <span>Devices</span>
                            </RouterLink>
                        </li>
                        <li class="nav-item">
                ...
                <div class="card-footer p-0 border-top-0">
                    ...
                    <div class="my-2 text-center fw-bold fs-10 text-body-quaternary">
                        <a class="text-body-quaternary me-1"
                           href="#">Privacy policy</a>•<a class="text-body-quaternary mx-1"
                                                          href="#">Terms</a>•<a class="text-body-quaternary ms-1"
                                                                                href="#">Cookies</a>
                    </div>
                </div>
            </div>
